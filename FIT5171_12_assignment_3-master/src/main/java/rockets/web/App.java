...
//        handleGetLaunches();
    ...
    private static void handlePostRegister() {
        post("/register", (req, res) -> {
            ...
            User user;
            try {
                /* CODE ADDED TO AVOID REGISTERING USER WITH SAME EMAIL */
                if (dao.getUserByEmail(email) != null) {
                    ...
                    if (user.getFirstName()==null || user.getLastName()==null){
                        attributes.put("errorMsg", "The first letter of name should be Capital.");
                        return new ModelAndView(attributes, "register.html.ftl");
                    } else if (user.getPassword() == null){
                        attributes.put("errorMsg", "Password should have a number, Uppercase, Lowercase, symbol and at least 8 characters.");
                        return new ModelAndView(attributes, "register.html.ftl");
                    }
    ...
    private static ModelAndView handleException(Response res, Map<String, Object> attributes, Exception e, String templateName) {
        ...
        logger.info("Code Error "+ e.getMessage());
